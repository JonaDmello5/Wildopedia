    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="space-y-8">
        <div className="space-y-4">
           <h1 className="text-4xl font-bold tracking-tight mb-2 font-headline">Search Wildopedia</h1>
           <SearchBar />
        </div>

        <div>
          <h2 className="text-2xl font-bold tracking-tight mb-2 font-headline">Search Results</h2>
