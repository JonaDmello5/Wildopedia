...
export const animals: Animal[] = [
  ...
  },
  {
    ...
    diet: 'Primarily herbivorous, mountain gorillas have a vegetarian menu consisting of leaves, stems, shoots, and roots of many plant species. A smaller portion of their diet is fruits (when in season). They also occasionally ingest ants, snails or grubs incidentally while eating foliage. An adult gorilla eats about 20–30 kg of food per day.',
  ...
  },
  {
    ...
    behavior: 'Orangutans are the least social of the great apes. Adult males are solitary, maintaining large overlapping home ranges that encompass those of several females. They generally come together only for mating. Adult females are usually accompanied only by their dependent offspring. The mother-infant bond in orangutans is one of the strongest in the animal kingdom: a baby orangutan clings to its mother’s body for the first year, nurses for 5–6 years, and stays with the mother learning survival skills for 7–8 (sometimes up to 9) years – the longest childhood of any non-human animal. This slow reproductive rate (a female gives birth only once every ~7–8 years) is a big factor in orangutan vulnerability. Males exhibit a curious phenomenon: some mature males do not develop cheek pads or large size until they can establish a territory – these are called unflanged males. Both flanged (cheek-padded) and unflanged males can father offspring, but the flanged males attract females with loud "long calls" that carry through the forest up to 1–2 km. These calls advertise the male’s presence and possibly help maintain spacing. Unflanged males roam widely in search of mating opportunities and may force copulations, whereas females preferentially seek out dominant flanged males when ready to conceive. Orangutans spend daylight hours foraging and moving through the trees with deliberate grace. They “quadrumanously” climb, using both hands and feet to grasp branches, and often brachiate (swing by arms). Despite their size, they can climb high and even hang upside down from branches to reach fruit. They are mostly quiet, but make various sounds: besides the males’ long call, orangutans will grunt or kisssqueak (a sharp suction sound) when irritated or as a mild alarm. An agitated orangutan may shake branches or throw things as a threat display. Every evening, each orangutan builds a new nest in the trees – bending branches to make a springy platform, and sometimes adding leafy “pillows” or roofs out of large leaves (they are known to fashion remarkably cozy sleeping nests). Orphaned or rehabilitated orangutans have even been observed making “umbrellas” out of big leaves to shelter from rain, indicating a high level of problem-solving. Tool use in the wild is not as common as in captive studies, but in some areas they use sticks to extract insects or seeds. Cultural behaviors (learned differences between populations) have been documented, such as using bundles of leaves as cushions or gloves to handle spiny fruits or to sit on prickly branches. Orangutans are generally peaceful; serious aggression is rare outside of mating competition. When two flanged males meet, they usually avoid each other, but if neither backs down, they can engage in a dramatic fight with biting and gouging that can inflict severe wounds.',
    status: {
      lifespan: '30-40 years in the wild',
      weight: 'Males ~75-120 kg, Females ~30-50 kg',
